...
VARIANTS = [
    ...
    },
    {
        ...
        'train_script': 'eval/backbone_norm_ablation/train_backbone_norm_ablation.py',
        'overrides': ['--post-train-backbone-norm-mode', 'none', '--post-train-backbone-checkpointing'],
    },
]
